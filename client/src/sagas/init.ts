...
// function* _createTodos(todos: TodoT[]) {
//   for (let i = todos.length - 1; i >= 0; i--) {
//     yield _createTodo(todos[i])
//   }
// }

// function* _createTodo({ title, description, comments = [], select = false }: any) {
...
// function* _createComments(todoId: number, comments: any) {
...
function* initialSetup() {
  try {
    ...
    // }
    yield put(rectangleActions.fetchRectanglesRequest())
