...
// function isCreating(state = false, action: AnyAction) {
//   switch (action.type) {
...
// function comments(state = [], action: AnyAction) {
//   switch (action.type) {
//     case commentsTypes.FETCH_COMMENTS_SUCCESS:
...
// function updating(state = [], action: AnyAction) {
//   switch (action.type) {
...
// function deleting(state = [], action: AnyAction) {
//   switch (action.type) {
